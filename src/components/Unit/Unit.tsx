...
import { faUser, faNoteSticky, faGear, faPlus, faTrash, faPen, faArrowDown, faArrowUp, faLink, faImage, faStickyNote, faEye } from '@fortawesome/free-solid-svg-icons';
...
function Unit() {
    ...
    async function handleExpandButton(nodeId: string) {
        ...
        setNodeResources(response.data.resources)
                        ...
                        unit ? (
                            <div className="max-h-160 overflow-y-auto pr-1">
                                <div className="mx-5 w-90% flex flex-col mt-5 ">
                                    ...
                                    <p className="text-lg font-display text-gray-500 italic">Owner : <span className="text-blue-500">{unit.owner.name}</span></p>
