...
function SideBar() {
    ...
    return (
        <div className="min-h-161 shadow-2xl border-2 border-gray-300 p-5 bg-gray-200 w-1/5">
            <div className="flex items-center border-2 rounded-xl px-2 shadow-xl bg-gradient-to-r from-[#a31be2] via-[#4204a0] to-[#29015f] cursor-pointer transition-all duration-300 transform hover:scale-105">
                ...
                <div className="mx-2">
                    <p className=" text-white font-bold">{userObject.user.name}</p>
                    <p className="text-sm text-gray-200">{userObject.user.email}</p>
                </div>
            </div>
